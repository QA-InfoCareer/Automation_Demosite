  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <Button style={{ backgroundColor: 'dodgerblue', margin: '0.5%', borderRadius: '5px', height: '30px', color: 'white' }} onClick={handleOpenModal}>Small modal</Button>
        <Button style={{ backgroundColor: 'dodgerblue', margin: '0.5%', borderRadius: '5px', height: '30px', color: 'white' }} onClick={handleOpenModal1}>Large modal</Button>
      </div>
    </div>
  )
}
